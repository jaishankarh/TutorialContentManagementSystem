...
//check that the captcha pprovided is valid..
function login_check_is_captcha_valid()
{
    require 'recaptcha.php';
    $response = recaptcha_check_answer(RECAPTCHA_PRIVATE, $_SERVER['REMOTE_ADDR'], $_REQUEST['recaptcha_challenge_field'], $_REQUEST['recaptcha_response_field']);
